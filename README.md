...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/karawun-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14857&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/karawun-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `karawun` can be installed with:

```
conda install karawun
```

It is possible to list all of the versions of `karawun` available on your platform with:
